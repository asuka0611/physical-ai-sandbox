...
TRANSLATIONS: Final[dict[str, dict[Language, str]]] = {
    ...
    "restart_viewport": {"en": "Restart Viewport", "ja": "Viewport再起動"},
    "restart_all": {"en": "Restart All", "ja": "全体再起動"},
    "emergency_stop": {"en": "Emergency Stop", "ja": "非常停止"},
    "viewport_max": {"en": "Maximize Viewport", "ja": "Viewport最大化"},
    "zen_mode": {"en": "Zen Mode", "ja": "Zen Mode"},
    "layout_reset": {"en": "Layout Reset", "ja": "Layout Reset"},
    "viewer": {"en": "Viewport", "ja": "Viewport"},
    "selected_joint": {"en": "Selected Joint", "ja": "選択関節"},
    "input_context": {"en": "Input Context", "ja": "入力状態"},
    "mode": {"en": "Mode", "ja": "Mode"},
    "help": {"en": "Help", "ja": "ヘルプ"},
    "quit": {"en": "Quit", "ja": "終了"},
